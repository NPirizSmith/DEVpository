...
export default function MobileNav() {
  ...
  return (
    <nav className='flex sticky bottom-0 justify-center gap-6 z-30 h-14 items-center mt-6 dark:bg-dark-900 lg:hidden bg-white shadow-black shadow-2xl'>
      ...
      <div className={`grid w-9 justify-center ${pathname === "/compartir" ? " border-t-2 border-dark-900 dark:border-white h-full content-center" : ""}`}><Link href="/compartir"><Plus /></Link></div>
